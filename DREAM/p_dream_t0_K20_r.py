...
with open("p_dream_t0_k20_r_emotion.json","w") as f:
...
with open("p_dream_t0_k20_r_motivation.json","w") as f:
    f.write(json.dumps(data,indent=4))
del data
...
with open("p_dream_t0_k20_r_rot.json","w") as f:
    f.write(json.dumps(data,indent=4))
del data
...
with open("p_dream_t0_k20_r_consequence.json","w") as f:
    f.write(json.dumps(data,indent=4))
del data
'''
