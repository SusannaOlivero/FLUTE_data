...
with open("p_dream_t0_k10_r_emotion.json","w") as f:
...
with open("p_dream_t0_k10_r_motivation.json","w") as f:
    f.write(json.dumps(data,indent=4))
del data
...
with open("p_dream_t0_k10_r_consequence.json","w") as f:
    f.write(json.dumps(data,indent=4))
del data
...
with open("p_dream_t0_k10_r_SE.json","w") as f:
    f.write(json.dumps(data,indent=4))
del data
