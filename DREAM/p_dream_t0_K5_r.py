...
with open("p_dream_t0_k2_emotion.json","w") as f:
...
with open("p_dream_t0_k2_motivation.json","w") as f:
    f.write(json.dumps(data,indent=4))
del data
...
with open("p_dream_t0_k2_rot.json","w") as f:
    f.write(json.dumps(data,indent=4))
del data
...
with open("p_dream_t0_k2_consequence.json","w") as f:
    f.write(json.dumps(data,indent=4))
del data
...
with open("p_dream_t0_k2_SE.json","w") as f:
    f.write(json.dumps(data,indent=4))
del data
