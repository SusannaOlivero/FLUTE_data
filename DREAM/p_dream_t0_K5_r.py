...
with open("p_dream_emotion_t0_k5_r.json","w") as f:
...
with open("p_dream_motivation_t0_k5_r.json","w") as f:
    f.write(json.dumps(data,indent=4))
del data
...
with open("p_dream_rot_t0_k5_r.json","w") as f:
    f.write(json.dumps(data,indent=4))
del data
...
with open("p_dream_consequence_t0_k5_r.json","w") as f:
    f.write(json.dumps(data,indent=4))
del data
...
with open("p_dream_SE_t0_k5_r.json","w") as f:
    f.write(json.dumps(data,indent=4))
del data
