...
with open("p_dream_k24_t0_emotion.json","w") as f:
...
with open("p_dream_k24_t0_motivation.json","w") as f:
    f.write(json.dumps(data,indent=4))
del data
...
with open("p_dream_k24_t0_rot.json","w") as f:
    f.write(json.dumps(data,indent=4))
del data
'''
# 1.4) Consequence
...
with open("p_dream_k24_t0_consequence.json","w") as f:
    f.write(json.dumps(data,indent=4))
del data
'''
