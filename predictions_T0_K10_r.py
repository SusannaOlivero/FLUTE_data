...
prompt_base = "Find if the 'premise' entails or contradicts the 'hypothesis'.\n"
prompt_base += "Here you can find some examples of answers:\n"
prompt_base += examples
...
with open("./output/prediction_t0_k10_r.json","w") as f:
